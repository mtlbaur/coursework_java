...
public class Talker
{
	...
	public Talker (Socket clientSocket, String id) throws IOException // client side
	{
		this.id = id;
	...
	public Talker (String domain, int port, String id) throws IOException // server side
	{
		this.id = id;
	...
	public void expect(String strExpected) throws Exception, IOException
	{
